...
use project7\pages\Login as LoginPage;

use project7\pages\MonEntreprise as Corporates;

use project7\pages\Program as Program;

use project7\pages\Registration;
